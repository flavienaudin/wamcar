...
final class Version20180830093946 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO user_preferences (user_id, private_message_email_enabled, private_message_email_frequency, like_email_enabled, like_email_frequency) (SELECT u.id, true, \'IMMEDIATELY\', true, \'ONCE_A_DAY\' FROM user u);');
    }
