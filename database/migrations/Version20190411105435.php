 ...
 */
final class Version20190411105435 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sale_declaration ADD CONSTRAINT FK_BEF0BAF55458D FOREIGN KEY (lead_id) REFERENCES lead (id)');
    }
