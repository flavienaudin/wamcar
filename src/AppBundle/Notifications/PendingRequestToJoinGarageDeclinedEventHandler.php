...
class PendingRequestToJoinGarageDeclinedEventHandler extends AbstractEmailEventHandler implements GarageMemberManagementEventHandler
{
    ...
    {
        $this->checkEventClass($event, PendingRequestToJoinGarageDeclinedEvent::class);
        ...
        $notificationRefusal = $this->notificationsManagerExtended->createNotification(
            ...
            $this->router->generate('front_garage_view', ['slug' => $garage->getSlug(), '_fragment' => 'sellers'])
        );
        try {
